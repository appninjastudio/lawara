...
const MOCK_BELGELER: Belge[] = [
  {
    id: 1, dosyaId: 1,
    belgeAdi: 'Ödeme Emri (Örnek 7)',
    dosyaAdi: 'odeme_emri_2024_1234.pdf',
    belgeKategorisi: 'odeme_emri',
    belgeKaynagi: 'uyap',
    dosyaBoyutu: 245760,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    uyapEvrakId: 'UYAP-EVR-2024-001234',
    uyapEvrakTuru: 'Ödeme Emri',
    uyapIndirmeTarihi: '2024-10-01',
    aciklama: 'İlamsız icra takibi ödeme emri. Borçlu Ahmet Yılmaz adına düzenlenmiştir.',
    onemliMi: true,
    etiketler: ['ödeme emri', 'ilamsız', 'tebligat'],
    depolamaYolu: '/belgeler/2024/1234/odeme_emri.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Talip Furkan Doğan',
    yukleyenKisiId: 1,
  ...
  {
    id: 2, dosyaId: 1,
    belgeAdi: 'Takip Talebi',
    dosyaAdi: 'takip_talebi_2024_1234.pdf',
    belgeKategorisi: 'takip_talebi',
    belgeKaynagi: 'uyap',
    dosyaBoyutu: 189440,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    uyapEvrakId: 'UYAP-EVR-2024-001230',
    uyapEvrakTuru: 'Takip Talebi',
    uyapIndirmeTarihi: '2024-10-01',
    aciklama: 'İcra takibi başlatma talebi.',
    onemliMi: true,
    etiketler: ['takip talebi', 'başvuru'],
    depolamaYolu: '/belgeler/2024/1234/takip_talebi.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Talip Furkan Doğan',
    yukleyenKisiId: 1,
    createdAt: '2024-10-01T08:00:00Z',
  ...
  {
    id: 3, dosyaId: 1,
    belgeAdi: 'Vekaletname - ABC Bankası',
    dosyaAdi: 'vekaletname_abc_bankasi.pdf',
    belgeKategorisi: 'vekaletname',
    belgeKaynagi: 'tarama',
    dosyaBoyutu: 1536000,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    uyapEvrakId: null,
    uyapEvrakTuru: null,
    uyapIndirmeTarihi: null,
    aciklama: 'ABC Bankası A.Ş. tarafından verilen genel icra vekaletnamesi.',
    onemliMi: true,
    etiketler: ['vekaletname', 'müvekkil', 'banka'],
    depolamaYolu: '/belgeler/2024/1234/vekaletname.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Talip Furkan Doğan',
    yukleyenKisiId: 1,
    createdAt: '2024-10-01T07:00:00Z',
    updatedAt: '2024-10-01T07:00:00Z',
  },
  {
    id: 4, dosyaId: 1,
    belgeAdi: 'Kredi Sözleşmesi',
    dosyaAdi: 'kredi_sozlesmesi_ahmet_yilmaz.pdf',
    belgeKategorisi: 'sozlesme',
    belgeKaynagi: 'manuel',
    dosyaBoyutu: 3145728,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    ...
    uyapEvrakTuru: null,
    uyapIndirmeTarihi: null,
    aciklama: 'Borçlu ile ABC Bankası arasındaki tüketici kredisi sözleşmesi. Kredi tutarı: ₺100.000',
    onemliMi: true,
    etiketler: ['sözleşme', 'kredi', 'tüketici kredisi'],
    depolamaYolu: '/belgeler/2024/1234/kredi_sozlesmesi.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Talip Furkan Doğan',
    yukleyenKisiId: 1,
    createdAt: '2024-10-01T07:30:00Z',
    updatedAt: '2024-10-01T07:30:00Z',
  },
  {
    id: 5, dosyaId: 1,
    belgeAdi: 'Tebligat Mazbatası - Ahmet Yılmaz',
    dosyaAdi: 'tebligat_mazbatasi_ahmet.pdf',
    belgeKategorisi: 'tebligat',
    belgeKaynagi: 'uyap',
    dosyaBoyutu: 102400,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    uyapEvrakId: 'UYAP-EVR-2024-001250',
    uyapEvrakTuru: 'Tebligat Mazbatası',
    uyapIndirmeTarihi: '2024-10-06',
    aciklama: 'Ödeme emrinin borçluya tebliğ edildiğine dair mazbata. 7201 s.K. m.21 uyarınca elden teslim.',
    onemliMi: false,
    etiketler: ['tebligat', 'mazbata', 'ödeme emri'],
    depolamaYolu: '/belgeler/2024/1234/tebligat_mazbatasi.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Sistem',
    yukleyenKisiId: 0,
  ...
  {
    id: 6, dosyaId: 1,
    belgeAdi: '89/1 Haciz İhbarnamesi - Ziraat Bankası',
    dosyaAdi: 'haciz_ihbarnamesi_89_1_ziraat.pdf',
    belgeKategorisi: 'haciz_ihbarnamesi',
    belgeKaynagi: 'uyap',
    dosyaBoyutu: 156672,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    uyapEvrakId: 'UYAP-EVR-2024-002100',
    uyapEvrakTuru: '89/1 Haciz İhbarnamesi',
    uyapIndirmeTarihi: '2024-11-01',
    aciklama: 'Ziraat Bankası Genel Müdürlüğüne gönderilen 89/1 haciz ihbarnamesi.',
    onemliMi: true,
    etiketler: ['haciz', '89/1', 'banka haczi', 'ziraat'],
    depolamaYolu: '/belgeler/2024/1234/haciz_ihbarnamesi_89_1.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Talip Furkan Doğan',
    yukleyenKisiId: 1,
  ...
  {
    id: 7, dosyaId: 1,
    belgeAdi: 'Banka Cevap Yazısı - Ziraat Bankası (Olumlu)',
    dosyaAdi: 'ziraat_cevap_olumlu.pdf',
    belgeKategorisi: 'banka_cevabi',
    belgeKaynagi: 'uyap',
    dosyaBoyutu: 87040,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    uyapEvrakId: 'UYAP-EVR-2024-002250',
    uyapEvrakTuru: 'Banka Cevap Yazısı',
    uyapIndirmeTarihi: '2024-11-08',
    aciklama: 'Ziraat Bankası olumlu cevap: Hesapta ₺12.450 bloke edildi.',
    onemliMi: true,
    etiketler: ['banka cevabı', 'olumlu', 'ziraat', 'bloke'],
    depolamaYolu: '/belgeler/2024/1234/ziraat_cevap.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Sistem',
    yukleyenKisiId: 0,
  ...
  {
    id: 8, dosyaId: 1,
    belgeAdi: 'Maaş Haczi Müzekkeresi',
    dosyaAdi: 'maas_haczi_muzakkere.pdf',
    belgeKategorisi: 'maaş_haczi_muzakkere',
    belgeKaynagi: 'uyap',
    dosyaBoyutu: 134144,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    uyapEvrakId: 'UYAP-EVR-2024-002500',
    uyapEvrakTuru: 'Maaş Haczi Müzekkeresi',
    uyapIndirmeTarihi: '2024-11-15',
    aciklama: 'ABC Tekstil A.Ş. işverenine gönderilen maaş haczi müzekkeresi. %25 kesinti.',
    onemliMi: false,
    etiketler: ['maaş haczi', 'müzekkere', 'işveren'],
    depolamaYolu: '/belgeler/2024/1234/maas_haczi_muzakkere.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Talip Furkan Doğan',
    yukleyenKisiId: 1,
  ...
  {
    id: 9, dosyaId: 1,
    belgeAdi: 'Ödeme Dekontu - ₺10.000 (Banka Havalesi)',
    dosyaAdi: 'dekont_10000_banka.jpg',
    belgeKategorisi: 'dekont',
    belgeKaynagi: 'manuel',
    dosyaBoyutu: 524288,
    dosyaTipi: 'image/jpeg',
    dosyaUzantisi: '.jpg',
    uyapEvrakId: null,
    uyapEvrakTuru: null,
    uyapIndirmeTarihi: null,
    aciklama: 'Borçludan alınan ₺10.000 kısmi ödeme dekontu.',
    onemliMi: false,
    etiketler: ['dekont', 'ödeme', 'havale'],
    depolamaYolu: '/belgeler/2024/1234/dekont_10000.jpg',
    onizlemeUrl: '/belgeler/2024/1234/thumb_dekont_10000.jpg',
    yukleyenKisi: 'Talip Furkan Doğan',
    yukleyenKisiId: 1,
  ...
  {
    id: 10, dosyaId: 1,
    belgeAdi: 'SGK Cevap Yazısı - Aktif Çalışan',
    dosyaAdi: 'sgk_cevap_aktif.pdf',
    belgeKategorisi: 'sgk_cevabi',
    belgeKaynagi: 'uyap',
    dosyaBoyutu: 76800,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    uyapEvrakId: 'UYAP-EVR-2024-001500',
    uyapEvrakTuru: 'SGK Sorgu Sonucu',
    uyapIndirmeTarihi: '2024-10-10',
    aciklama: 'SGK sorgu sonucu: Borçlu ABC Tekstil A.Ş. bünyesinde 4/a kapsamında aktif çalışan.',
    onemliMi: false,
    etiketler: ['sgk', 'sorgu', 'aktif çalışan'],
    depolamaYolu: '/belgeler/2024/1234/sgk_cevap.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Talip Furkan Doğan',
    yukleyenKisiId: 1,
  ...
  {
    id: 11, dosyaId: 1,
    belgeAdi: '103 Davetiyesi - Kıymet Takdiri',
    dosyaAdi: '103_davetiye_kiymet.pdf',
    belgeKategorisi: 'kiymet_takdiri',
    belgeKaynagi: 'uyap',
    dosyaBoyutu: 112640,
    dosyaTipi: 'application/pdf',
    dosyaUzantisi: '.pdf',
    uyapEvrakId: 'UYAP-EVR-2025-000150',
    uyapEvrakTuru: '103 Davetiyesi',
    uyapIndirmeTarihi: '2025-01-15',
    aciklama: 'Taşınmaz kıymet takdiri için 103 davetiyesi.',
    onemliMi: false,
    etiketler: ['103 davetiye', 'kıymet takdiri', 'taşınmaz'],
    depolamaYolu: '/belgeler/2024/1234/103_davetiye.pdf',
    onizlemeUrl: null,
    yukleyenKisi: 'Talip Furkan Doğan',
    yukleyenKisiId: 1,
